...
int main(){
    ...
    ///Alice and bob play a game, in 
    /// Each turn alice or bob can take a suffix or prefix of the array
    /// find how much more alice will get from bob if both played optimally 
    cin>>test;
    while(test--){
        cin>>n;
        vi arr(n);
